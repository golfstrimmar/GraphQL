...
export const dBT = [
  "font-size: 14px;color: #64ffda;font-weight: 400;line-height: 1;font-family: 'Montserrat', sans-serif;display: inline-flex;align-items: center;justify-content: center;cursor: pointer;gap: 0.5rem;padding: 0.25rem 0.5rem;border-radius: 0.25rem;transition: all 200ms ease-in-out;box-shadow: 0 1px 2px rgba(15, 23, 42, 0.08);border: 1px solid  #64ffda; &:hover {color: #000000;background-color: #64ffdb86;}; &:active {transform: translateY(1px);}",
  "font-size: 16px; color: #e6f1ff; font-weight: 500; line-height: 1; font-family:  'Montserrat', sans-serif; display: inline-flex; align-items: center; justify-content: center; cursor: pointer; gap: 0.5rem; padding: 0.25rem 0.5rem; border-radius: 0.25rem; transition: all 200ms ease-in-out; box-shadow: 0 1px 2px rgba(15, 23, 42, 0.08); background-color: #4d6a92; border: 1px solid #4d6a92; &:hover { border: 1px solid #112240; background-color: #233554; } &:active { transform: translateY(1px);}",
  "font-size: 16px; color: #ffffff; font-weight: 500; line-height: 1; font-family: 'Montserrat', sans-serif; display: inline-flex; align-items: center; justify-content: center; cursor: pointer; gap: 0.5rem; padding: 0.25rem 0.5rem; border-radius: 0.25rem; transition: all 200ms ease-in-out; box-shadow: 0 1px 2px rgba(15, 23, 42, 0.08); background-color: red; &:hover { background-color: #ce0202; } &:active { transform: translateY(1px); }",
  "font-size: 16px; color: #ffffff; font-weight: 500; line-height: 1; font-family: 'Montserrat', sans-serif; display: inline-flex; align-items: center; justify-content: center; cursor: pointer; gap: 0.5rem; padding: 0.25rem 0.5rem; border-radius: 0.25rem; transition: all 200ms ease-in-out; box-shadow: 0 1px 2px rgba(15, 23, 42, 0.08); border: 1px solid #4d6a92; &:hover { border: 1px solid #8892b0; } &:active { transform: translateY(1px); }",
  "font-size:14px; font-weight:500; line-height:1; font-family:'Montserrat', sans-serif; display: flex;align-items: center;padding: 12px 16px;border-radius: 8px;background-color: #022c22;border: 1px solid #021914;color: #a7f3d0;cursor: pointer; &:hover { background-color: #02a680; } &:active { transform: translateY(1px); }",
  "font-size:22px; color:#000000; font-weight:600; line-height:1; font-family:'Montserrat', sans-serif;",
  "font-size:24px; color:#000000; font-weight:700; line-height:1; font-family:'Montserrat', sans-serif;",
  "font-size:26px; color:#000000; font-weight:800; line-height:1; font-family:'Montserrat', sans-serif;",
  "font-size:28px; color:#000000; font-weight:800; line-height:1; font-family:'Montserrat', sans-serif;",
