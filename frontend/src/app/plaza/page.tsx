  ...
  return (
    <section className=" pt-[80px] min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-slate-50 pb-[500px]">
      <div className="container">
        ...
        <CanvasComponent />
        <ProjectsList />
        <div id="admin-siction" className="fixed bottom-0 left-0 w-full z-[5000] transition-transform duration-[200ms] [transition-timing-function:cubic-bezier(0.4,0,0.2,1)]  translate-y-[100%] group">
